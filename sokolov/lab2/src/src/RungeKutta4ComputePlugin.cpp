...
#include "RungeKutta4ComputePlugin.hpp"
...
int RungeKutta4ComputePlugin::Execute(Result* in) {
    in->methodName = this->PluginName();
    std::cout << "RungeKutta4ComputePlugin is executed\n";
    float x[3];
...
{
    std::cout << "RungeKutta4ComputePlugin is loaded\n";
    return new RungeKutta4ComputePlugin();
}